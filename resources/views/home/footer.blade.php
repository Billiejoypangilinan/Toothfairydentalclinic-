<footer class="footer">
    ...
    <div class="footer-top section">
      <div class="container">
        ...
        <div class="footer-brand">
          ...
          <a href="#" class="logo">Tooth Fairy</a>

          <p class="footer-text">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Soluta quo sequi obcaecati provident, exercitationem repellat explicabo dolores vel consequatur placeat, harum quas ipsum ipsam reprehenderit cum quod vitae. Ipsa, iste?
          </p>
  ...
  <!-- 
    - custom js link
  -->
  <script src="{{asset('home_js/script.js')}}" defer></script>
