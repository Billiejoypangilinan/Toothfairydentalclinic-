...
<head>
  ...
  <title>Tooth Fairy: Dental Clinic System</title>
          ...
          <div class="card-body">
            ...
            <form class="mb-3" data-parsley-validate>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" name="email" autofocus autocomplete="off" required placeholder="email@mail.com" />
              </div>
